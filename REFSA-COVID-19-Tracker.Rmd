...
plot_bar <- plot_base +
  ...
  xlab("") + 
  ylab("") + 
  labs(title = "Announced government* stimulus in % of GDP", subtitle = "Last updated: 6 April 2020.", caption = "* Excludes central bank measures.\n Sources: IMF, Bloomberg, Financial Times, Japan Times, Jakarta Post, REFSA calculations.") + 
...
plot_adj_bar <- plot_adj_base +
  ...
  xlab("") + 
  ylab("") + 
  labs(title = "Announced government* stimulus in % of GDP (adjusted)", subtitle = "Last updated: 6 April 2020.", caption = "* Excludes central bank measures.\n Sources: IMF, Bloomberg, Financial Times, Japan Times, Jakarta Post, REFSA calculations.") + 
  theme(axis.line.y = element_blank(), axis.ticks.y = element_blank())
...
plot_stringency <- ggplot(data = stim_stringency, aes(x = max_stringency_idx, y = fisc_stim_percent_gdp)) + 
  ...
  labs(title = "Size of stimulus is not proportional to stringency of social distancing", 
